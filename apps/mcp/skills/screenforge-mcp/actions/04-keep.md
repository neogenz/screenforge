...
1. **Read the library.** Call `screenforge_list_templates` to see what is already saved on this browser, across every project on the active platform. Templates from other platforms are hidden.
...
4. **Report.** Name the saved templates to the user and say they are reusable from the template picker in any project on the same platform in this browser.
