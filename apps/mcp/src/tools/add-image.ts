...
export const ADD_IMAGE_SCHEMA: ParamSchema = {
  ...
  properties: {
    ...
    role: {
      ...
      description:
        '« image » pose un calque image (un logo). « screenshot » pose un cadre compatible portant la capture.',
    },
    ...
    layerId: {
      ...
      maxLength: 64,
      description:
        'Pour « screenshot » : remplit un cadre déjà posé au lieu d’en ajouter un. Le cadrage existant est conservé.',
    },
