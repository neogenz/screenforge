...
journey
  section Setup
    Mettre #22 sur le main coss contenant #23 et #26 => les 23 conflits textuels observés pendant la fusion sont résolus sur le diff courant: 5: cli
  section Happy path
...
| --- | --- |
| 1 | Les 23 conflits observés conservent simultanément fondation coss, analytics consentie, export multi-store et CSP minimale. |
