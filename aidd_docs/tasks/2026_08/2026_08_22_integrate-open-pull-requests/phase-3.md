...
```mermaid
flowchart TD
  A[Main contient #23] --> B[Mettre #22 à jour]
...
journey
  section Setup
    Mettre #22 sur le main contenant #23 => trois conflits connus reclassifiés sur le diff courant: 5: cli
  section Happy path
...
2. Dans `App.tsx`, conserver initialisation d’identité consentie et sélection de cible.
3. Dans `use-export.ts`, conserver instrumentation expurgée et types `StoreTargetProfile`.
