...
| Un accent citron unique, réservé à l'état — renverse « monochrome intégral »                | Un chrome sans aucune couleur ne sait plus dire « vous êtes ici » : l'écran courant, le calque sélectionné et le focus se disputaient les mêmes gris. L'accent ne touche ni l'action (Exporter reste un aplat clair) ni l'artboard (anneau, cadre et repères restent neutres) |
